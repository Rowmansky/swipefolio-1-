...
// Creating custom SVG icons that perfectly match the iOS reference
const SwordIcon = () => (
...
export default function DailyMissionsGrid() {
  ...
  const missions = [
    ...
    },
    {
      ...
      customTitle: (
        <div>
          <span className="text-black font-semibold text-base leading-tight block">Make a</span>
          <span className="text-black font-semibold text-base leading-tight block">Trade</span>
        </div>
      ),
      icon: <PercentIcon />,
      xpValue: 5,
    ...
    },
    {
      ...
      customTitle: (
        <div>
          <span className="text-black font-semibold text-base leading-tight block">Review</span>
          <span className="text-black font-semibold text-base leading-tight block">Your Moves</span>
        </div>
      ),
      icon: <ListIcon />,
      xpValue: 10,
    ...
    },
    {
      ...
      customTitle: (
        <div>
          <span className="text-black font-semibold text-base leading-tight block">2-Day</span>
          <span className="text-black font-semibold text-base leading-tight block">Streak</span>
        </div>
      ),
      icon: <FlameIcon />,
      xpValue: 25,
