...
const StackCard = ({ stack, onClick }: StackCardProps) => (
  ...
  >
    ...
    >
      ...
      <h3 className="text-white font-bold text-lg z-10 px-4 text-center leading-snug tracking-tight">
        {stack.title}
      </h3>
    </div>
    <div className="p-3">
...
export default function SwipeableStacks({ stacks }: SwipeableStacksProps) {
  ...
  return (
    <div className="mb-4 relative">
      <h2 className="text-xl font-bold text-slate-900 mb-3">Popular Stacks</h2>

      <div
        className="bg-slate-100 rounded-xl p-3.5 relative"
